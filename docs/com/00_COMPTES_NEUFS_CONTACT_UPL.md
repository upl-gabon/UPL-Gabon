...
## 1. Ce qu’on ouvre / ce qu’on laisse

Au Gabon, les cibles (bacheliers, parents, cadres, institutions) sont surtout sur **WhatsApp, Facebook et TikTok**. LinkedIn sert le MBA et les entreprises. Instagram se crée en même temps que Facebook (même maison Meta), sans travail en plus.
...
## 2. Propriété — non négociable

- E-mail de **tous** les comptes : **`contact@upl-gabon.com`** (PrivateEmail / Namecheap). **Ne jamais** un Gmail perso.
- **2 administrateurs UPL** minimum (Président ou secrétariat + un second de l’institution).
- Jamais un prestataire, une agence ou un appui ponctuel **seul** propriétaire.
- Calvin Blanchard MINANG : **pas** admin public, **pas** contact affiché. S’il aide à la création, il est retiré des admins dès que les 2 comptes UPL sont en place.
- 2FA : application d’authentification sur **téléphones UPL** (+241 02 62 19 78 / +241 07 35 95 72 / présidence +241 05 01 56 20). Codes de secours : enveloppe au secrétariat, **pas dans GitHub**.
- Mot de passe : coffre (gestionnaire), **jamais** collé dans le chat ni dans le dépôt.

---

## 3. Ordre de création (une séance, ~90 min)
...
1. tiktok.com → inscription e-mail **`contact@upl-gabon.com`**.
2. Compte **Compte Pro** / Établissement d’enseignement.
3. @upl.gabon — bio § 4.
...
1. Chaîne Google liée à **`contact@upl-gabon.com`**.
2. Nom : Université Privée de Libreville — UPL · identifiant **@UPLGabon**.
3. Ne pas utiliser `@UPL` (collision mondiale).
4. Bannière / avatar : logo. Description : bio § 4.
5. Quand la chaîne est à nous : y **ajouter** (pas réuploader si les droits sont déjà UPL) les deux films déjà en ligne :
   - Présentation institutionnelle : https://youtu.be/jh_iCTJuLKA
   - Interview Executive MBA : https://youtu.be/FAKHfv8nN7I
6. **Ne pas** remettre en avant la vidéo « Rentrée 2024 » (retirée du site sur demande du Président).
...
```
Université Privée de Libreville. Executive MBA depuis 2022. Pré-inscriptions 2026-2027 : Licence, Master, CPGE, DBA. Sablière.
upl-gabon.com
```

**Moyenne (Facebook À propos, LinkedIn, YouTube) :**

```
Université Privée de Libreville (UPL) — établissement privé d’enseignement supérieur, Sablière, Libreville.
...
Pré-inscriptions 2026-2027 : Licence, Master, CPGE, Executive MBA, DBA. Pré-inscription gratuite, sans engagement.
...
## 5. Après création — avant le premier post
...
| Réseau | URL officielle (à coller une fois créé) |
|---|---|
| WhatsApp | |
| Facebook | |
| Instagram | |
