# Textes à valider — rentrée 2026-2027

**Statut : BROUILLON.** Aucun envoi, aucun post, aucun statut WhatsApp tant que le Président n’a pas écrit **VALIDÉ** en face de la pièce.

Source des chiffres : site officiel / `config.js` — ne pas modifier un tarif.

Légende : `[ ] à valider` · `[x] validé` · `publié le …` (date réelle seulement).
...
Merci de votre message. Indiquez :
• votre nom
• un numéro de téléphone
• la formation souhaitée (Licence, Master, CPGE, Executive MBA ou DBA)

Un membre du secrétariat vous répond en jours ouvrés.
...
## P1 — Annonce générale pré-inscriptions (lancement)

**Réseaux :** Facebook, Instagram, WhatsApp (statut + listes), TikTok (texte à l’écran), LinkedIn  
**Visuel :** `visuels/01-preinscriptions-carre.png`
...
**TikTok / Reels (20 s, voix secrétariat ou Président — pas de voix « IA »).**  
À l’écran : logo, « Pré-inscriptions 2026-2027 », upl-gabon.com.  
...
## P2 — Licence 1 (bacheliers et parents)

**Réseaux :** Facebook, Instagram, WhatsApp, TikTok  
**Visuel :** `visuels/02-licence1-carre.png`

```
Licence 1 — Université Privée de Libreville
...
## P3 — Executive MBA (cadres et dirigeants)

**Réseaux :** LinkedIn (prioritaire), Facebook, WhatsApp listes cadres  
**Visuel :** `visuels/03-mba-carre.png`

```
Executive MBA — Université Privée de Libreville
...
ou dépôt au secrétariat, Sablière.
...
**Réseaux :** Facebook, Instagram, WhatsApp, LinkedIn  
**Visuel :** `visuels/04-tarifs-carre.png`

```
Droits de scolarité — rentrée 2026-2027
...
**Réseaux :** Facebook, Instagram, LinkedIn  
**Visuel :** `visuels/06-poles-carre.png`

```
Les formations de la rentrée 2026-2027 s’organisent autour de cinq pôles, plus les classes préparatoires :
...
## P6 — Comment se pré-inscrire

**Réseaux :** tous + story WhatsApp/Instagram  
**Visuel :** `visuels/05-contact-story.png`

```
Pré-inscription 2026-2027 — trois étapes
...
## P7 — Paiement (factuel, pas « promo »)

**Réseaux :** Facebook, WhatsApp  
**Visuel :** aucun (ou logo seul)

```
Modalités de paiement — UPL

La scolarité est payable en tranches. L’échéancier est remis par le secrétariat à l’inscription.

Règlement possible par Airtel Money : conservez votre justificatif de paiement. La confirmation de l’UPL est indispensable.

Un reçu UPL est délivré à chaque versement. Joignez-le à votre dossier.
...
## P8 — Replay télévision

**Réseaux :** Facebook, YouTube, WhatsApp, LinkedIn  
**Visuel :** miniature YouTube officielle (pas de fausse miniature)

```
L’UPL à la télévision

Présentation de l’institution (Télévision Régionale) :
https://youtu.be/jh_iCTJuLKA

Interview — Executive MBA :
https://youtu.be/FAKHfv8nN7I

Université Privée de Libreville — Sablière
https://upl-gabon.com
```
...
## P9 — Entreprises / institutions (partenariats)

**Réseaux :** LinkedIn, e-mail contact@  
**Visuel :** logo ou `01-preinscriptions-carre.png`

```
Université Privée de Libreville — partenariats

L’UPL forme des cadres à Libreville depuis 2022 (Executive MBA, appui de l’Université de Douala).

Nous étudions, au cas par cas, des coopérations avec des entreprises et des institutions : stages, modules professionnels, appui à la formation des équipes.

Il ne s’agit pas d’un partenariat déjà conclu : un premier échange avec le secrétariat permet de voir si un travail commun a du sens.

contact@upl-gabon.com — objet « Partenariat »
https://upl-gabon.com
```

Validation Président : [ ]

**Interdit dans ce post :** nommer HEC, Polytechnique, Sciences Po ou toute école française non signée · brief France · dossier Ecobank.

---

## P10 — Accusé de réception secrétariat (e-mail / WhatsApp)

**Usage interne** dès qu’un lead arrive. E-mail **uniquement** contact@ — pas d’admissions@.

```
Bonjour,

Nous avons bien reçu votre demande concernant [Licence 1 / Master 1 / Master 2 / CPGE / Executive MBA / DBA].
Le secrétariat vous recontacte en jours ouvrés pour les pièces et les prochaines étapes.

Cordialement,
Secrétariat — Université Privée de Libreville
contact@upl-gabon.com
+241 02 62 19 78 · +241 07 35 95 72
https://upl-gabon.com
```
